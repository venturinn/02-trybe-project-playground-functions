...
## Data de Entrega
  ...
  - Data de entrega para avaliação final do projeto: `19/11/2021 - 14:00h`.
...
1. Clone o repositório
  * `git clone git@github.com:tryber/sd-018-a-project-playground-functions.git`
  * Entre na pasta do repositório que você acabou de clonar:
    * `cd sd-018-a-project-playground-functions`
...
6. Crie um novo `Pull Request` _(PR)_
  * Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-018-a-project-playground-functions/pulls)
  ...
  * Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-018-a-project-playground-functions/pulls) e confira que o seu _Pull Request_ está criado. 😀
